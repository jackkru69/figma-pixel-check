...
design/figma/
  ...
  styles/<id>.json              Figma's values of every node (figma-styles.js through use_figma), for the style check
...
- `left` and `width` (optional, both or neither) make a section a region: only those columns are compared,
...
Pixels cannot tell a wrong font weight from Figma's, a radius of 8 from 12 or `#475467` from `#667085` on
13 px text: the benchmark caught 3 of 12, 1 of 12 and 0 of 11 of those by pixels. Figma's own values can.
...
- hero: «@alexkim» color #6B7080 → #475467
